...
print <<EOF ;
<html><head><title>CGI Results</title></head><body><h1>Hello, world.</h1>Your CGI input variables were:<ul>
EOF
...
if ($cgivars{'agree1'} eq "on" && $cgivars{'agree2'} eq "on") { 

print <<EOF ;
<html>
<head>
    <meta http-equiv="refresh" content="0;url=http://mypage.iu.edu/~stgrimes/dict/dict2.html">
...
print <<EOF ;
You must accept the terms of the agreeement.
EOF
}
